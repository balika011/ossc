...
void __attribute__((noinline, __section__(".rtext"))) flash_erase_4k(uint32_t addr)
{
	// Write enable
	flash_flash_cmd_cfg_t flash_cmd_cfg;
	flash_cmd_cfg.opcode = CMD_WRITE_ENABLE;
	...
	// Sector erase
	flash_cmd_cfg.opcode = CMD_ERASE_4K;
...
void __attribute__((noinline, __section__(".rtext"))) flash_erase_32k(uint32_t addr)
{
	// Write enable
	flash_flash_cmd_cfg_t flash_cmd_cfg;
	flash_cmd_cfg.opcode = CMD_WRITE_ENABLE;
	...
	// Sector erase
	flash_cmd_cfg.opcode = CMD_ERASE_32K;
	flash_cmd_cfg.address_bytes = 3;
	flash_cmd_cfg.data_type = 0;
	flash_cmd_cfg.data_bytes = 0;
	flash_cmd_cfg.dummy_cycles = 0;
...
void __attribute__((noinline, __section__(".rtext"))) flash_erase_64k(uint32_t addr)
{
	// Write enable
	flash_flash_cmd_cfg_t flash_cmd_cfg;
	flash_cmd_cfg.opcode = CMD_WRITE_ENABLE;
