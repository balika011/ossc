...
void controls_setup()
{
	...
	strncpy(menu_row1, "Saving...", LCD_ROW_LEN + 1);
	menu_row2[0] = 0;
	ui_disp_menu(1);
...
int	controls_parse()
{
    ...
    uint32_t btn_vec, btn_vec_prev=1;
    uint8_t pt_only = 0;
    ...
    switch (i) {
        ...
        case RC_INFO:
            ...
            break;
        case RC_LCDBL:
			SC->sys_ctrl.lcd_bl_on = !SC->sys_ctrl.lcd_bl_on;
			break;
        case RC_SL_MODE:
